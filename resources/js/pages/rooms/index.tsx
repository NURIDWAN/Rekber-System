                    ...
                    <section className="mx-auto max-w-6xl px-4 pt-12 lg:px-6">
                        <div className="flex flex-wrap items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div
                                    className={`flex items-center gap-2 rounded-2xl px-4 py-3 text-sm font-semibold shadow-sm ring-1 cursor-pointer transition-all ${isConnected
...
RoomsIndex.layout = (page: React.ReactNode) => (
